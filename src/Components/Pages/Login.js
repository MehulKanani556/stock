                  ...
                  {page === "login" &&  <div className='xl:w-1/2 lg:w-2/3 md:w-4/5 sm:w-2/3 w-5/6'>
                     <div className='shadow-[1px_1px_20px_0.5px_rgba(0,0,0,0.06)] p-6'>
                         ...
                         <form action="" className='mt-4'>
                           ...
                           <button onClick={handleLogin} className='w-full bg-d_color border border-d_color transition duration-300 ease-in-out text-white h-[40px] rounded-[5px] mt-10 hover:bg-white hover:border hover:border-d_color hover:text-d_color'>Login</button>
                         </form>
                     </div>
                   </div>}
                   ...
                   {page === "password" &&  <div className='xl:w-1/2 lg:w-2/3 md:w-4/5 sm:w-2/3 w-5/6'>
                     <div className='shadow-[1px_1px_20px_0.5px_rgba(0,0,0,0.06)] p-6'>
                         ...
                         <form action="" className='mt-5'>
                           ...
                           <button onClick={()=> setPage("verify")} className='w-full bg-d_color border border-d_color transition duration-300 ease-in-out text-white h-[40px] rounded-[5px] mt-8 hover:bg-white hover:border hover:border-d_color hover:text-d_color'>Send OTP</button>
                         </form>
                     </div>
                   </div>}
                   ...
                   {page === "verify" && <div className='xl:w-1/2 lg:w-2/3 md:w-4/5 sm:w-2/3 w-5/6'>
                     <div className='shadow-[1px_1px_20px_0.5px_rgba(0,0,0,0.06)] p-6'>
                         ...
                         <form action="" className='mt-5'>
                           ...
                           <button onClick={()=> setPage("reset")} className='w-full border border-d_color bg-d_color transition duration-300 ease-in-out text-white h-[40px] rounded-[5px] hover:bg-white hover:border hover:border-d_color hover:text-d_color mt-12'>Verify</button>
                   ...
                   { page === "reset" &&  <div className='xl:w-1/2 lg:w-2/3 md:w-4/5 sm:w-2/3 w-5/6'>
                     <div className='shadow-[1px_1px_20px_0.5px_rgba(0,0,0,0.06)] p-6'>
                         ...
                         <form action="" className='mt-5'>
                           ...
                           <button className='w-full bg-d_color border border-d_color transition duration-300 ease-in-out text-white h-[40px] rounded-[5px] hover:bg-white hover:border hover:border-d_color hover:text-d_color mt-10'>Reset Password</button>
                         </form>
                     </div>
                   </div>}
