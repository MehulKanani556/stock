...
import '../CSS/Dhruvin/Expenses.css'
          ...
          <div className='sm:px-8 px-4 pt-7'>
              <div className='flex justify-between xl:flex-nowrap flex-wrap'>
                 ...
                 <div className='flex xl:flex-wrap lg:flex-nowrap flex-wrap '>
                                       ...
                                       <div className='px-6 mt-6'>
                                          <div className='mb-4'>
                                               ...
                                               <select className='ds_report_date border border-d_color h-[40px] rounded-[5px] w-full px-3'>
                                                 ...
                                                 <option value="">Foods & Snacks</option>
                                               </select>
                                          </div>
                                       </div>
                    ...
                    <div className='pt-3'>
                      <button className='ds_expense_btn' onClick={()=> navigate("/Layout/AddExpenseCategory")}>+ Add Expense Category</button>
                    </div>
                 </div>
              </div>
