            ...
            <div className='ds_main'>
                <div className='sm:px-8 px-4 pt-7'>
                    <div className='flex justify-between xl:flex-nowrap flex-wrap'>
                        <div>
                            <h2 className='text-d_color text-[24px] font-medium'>Low Stocks</h2>
                            <p className='cursor-pointer'><Link to="/Layout/Dashboard" className='text-[#727272]'>Dashboard /</Link> <span className='text-d_color font-semibold'>Low Stocks</span></p>
                        </div>
                                                ...
                                                <DialogPanel transition className="pointer-events-auto relative w-screen max-w-md transform transition duration-500 ease-in-out data-closed:translate-x-full sm:duration-700">
                                                    ...
                                                    <div className="flex h-full flex-col overflow-y-scroll bg-white py-4 shadow-xl">
                                                        ...
                                                        <div className='px-6 mt-6'>
                                                            <div className='mb-4'>
                                                                <label className='text-d_color font-medium block mb-1'>Wearhouse</label>
                                ...
                                <table className='w-full ds_income_table'>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <button onClick={() => navigate("/Layout/EditLowStocks")} className='ds_crud_btn me-3'>
                                                        <img src={Pen} alt="" />
                                                    </button>
