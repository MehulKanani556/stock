            ...
            <div className='ds_main'>
                <div className='sm:px-8 px-4 pt-7'>
                    <div className='flex justify-between xl:flex-nowrap flex-wrap'>
                        <div>
                            <h2 className='text-d_color text-[24px] font-medium'>Category</h2>
                            <p className='cursor-pointer'><Link to="/Layout/Dashboard" className='text-[#727272]'>Dashboard /</Link> <span className='text-d_color font-semibold'>Category</span></p>
                        </div>
                        <div className='flex xl:flex-nowrap lg:flex-wrap flex-wrap '>
                            ...
                            <div className='pt-3'>
                                <button className='ds_add_currency' onClick={() => navigate("/Layout/AddCategory")}>+ Add Category</button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <button onClick={() => navigate("/Layout/EditCategory")} className='ds_crud_btn me-3'>
                                                        <img src={Pen} alt="" />
                                                    </button>
