            ...
            <div className='ds_main'>
                <div className='sm:px-8 px-4 pt-7'>
                    <div>
                        ...
                        <p className='cursor-pointer'><Link to="/Layout/Dashboard" className='text-[#727272]'>Dashboard /</Link> <Link to="/Layout/SubCategory" className='text-[#727272]'>Subcategory /</Link> <span className='text-d_color font-semibold'>Add Subcategory</span></p>
                    </div>
                    <div className='pt-7'>
                            ...
                            <div className='sm:px-8 px-2 pb-7 pt-8'>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap">
                                        ...
                                        <div className="lg:w-1/3 md:1/3 sm:w-full w-full mb-5 px-4 pt-1">
                                            <div>
                                                <label htmlFor="email" className="block mb-1 text-md font-medium text-d_color dark:text-white">Subcategory Name</label>
