      ...
      <div className='ds_main'>
       <div className='sm:px-8 px-4 pt-7'>
          <div>
             ...
             <p className='cursor-pointer'><span onClick={()=> navigate("/Layout/Dashboard")} className='text-[#727272]'>Dashboard /</span> <span onClick={()=> navigate("/Layout/TaxRated")} className='text-[#727272]'>Tax Rates /</span> <span className='text-d_color font-semibold'>Edit Tax Rates</span></p>
          </div>
          <div className='pt-7'>
