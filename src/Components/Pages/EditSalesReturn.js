    ...
    <div>
      <div className='ds_main'>
       <div className='sm:px-8 px-4 pt-7'>
          <div>
             <h2 className='text-d_color text-[24px] font-medium'>Edit Sales Return</h2>
             <p className='cursor-pointer'><span onClick={()=> navigate("/Layout/Dashboard")} className='text-[#727272]'>Dashboard /</span> <span onClick={()=> navigate("/Layout/SalesReturn")} className='text-[#727272]'>Sales /</span> <span className='text-d_color font-semibold'>Edit Sales Return</span></p>
          </div>              
          <div className='pt-7'>
