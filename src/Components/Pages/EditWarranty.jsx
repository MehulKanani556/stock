        ...
        <div>
            <div className='ds_main'>
                <div className='sm:px-8 px-4 pt-7'>
                    <div>
                        <h2 className='text-d_color text-[24px] font-medium'>Edit Warranty</h2>
                        <p className='cursor-pointer'><Link to="/Layout/Dashboard" className='text-[#727272]'>Dashboard /</Link> <Link to="/Layout/Warranty" className='text-[#727272]'> Warranty /</Link> <span className='text-d_color font-semibold'>Edit Warranty</span></p>
                    </div>
                    <div className='pt-7'>
