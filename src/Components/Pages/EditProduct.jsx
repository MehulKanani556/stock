        ...
        <div>
            <div className='ds_main'>
                <div className='sm:px-8 px-4 pt-7'>
                    <div>
                        <h2 className='text-d_color text-[24px] font-medium'>Edit Product</h2>
                        <p className='cursor-pointer'><Link to="/layout/dashboard" className='text-[#727272]'>Dashboard /</Link> <Link to="/layout/product" className='text-[#727272]'>Product /</Link> <span className='text-d_color font-semibold'>Edit Product</span></p>
                    </div>
                    <div className='pt-7'>
                        ...
                        Next
                                ...
                                <div className="flex flex-wrap">
                                    ...
                                    <div className="lg:w-1/3 md:1/3 sm:w-full w-full mb-5 px-4 pt-1">
                                        <div>
                                            ...
                                            // disabled={location.state?.productType}
                                            >
                                ...
                                <div className='flex justify-center mt-8 mb-3'>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            goNext();
                                            navigate('/layout/EditProduct2', { state: { productType } });
                                        }}
                                        disabled={currentStep === steps.length - 1}
                                    >Next</button>
                                </div>
